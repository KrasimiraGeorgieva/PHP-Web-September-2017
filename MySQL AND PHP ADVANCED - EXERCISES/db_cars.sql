...
-- Dumping data for table cars.cars: ~14 rows (approximately)
...
-- Dumping data for table cars.customers: ~14 rows (approximately)
...
-- Dumping data for table cars.sales: ~14 rows (approximately)
